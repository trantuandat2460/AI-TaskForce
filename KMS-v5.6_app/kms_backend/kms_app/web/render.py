...
<meta name="viewport" content="width=device-width,initial-scale=1"><title>{esc(title)} · KMS v5.6</title>
<style>{CSS}</style></head><body><div class="shell">
<aside class="sidebar"><div class="sb-brand"><span class="dot"></span><b>VSI · KMS</b><span class="ver">v5.6</span></div>
<div class="who"><div class="nm">{esc(me['user_id'])}</div><div class="rl">{esc(me['role'])} · {esc(me['department'])} {CL(me['clearance'])}</div></div>
<nav class="nav">{nav}</nav>
<div class="sb-foot">stdlib · SQLite · fail-closed<br>data/ chứa toàn bộ dữ liệu runtime</div></aside>
...
def login_page(err=""):
    ...
    return f"""<!doctype html><html lang="vi"><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1"><title>Đăng nhập · KMS v5.6</title><style>{CSS}
...
<span style="margin-left:auto;font-family:var(--mono);font-size:11px;color:var(--muted)">v5.6</span></div>
